...
<div class="container">
  <div class="row">
    <div class="col s12">
      <p class="center-align"><?php echo _ABOUT; ?></p>

      <p style="text-align:justify"><?php echo _TEXTEABOUT; ?></p>

      <p class="center-align"><?php echo _QUI; ?></p>

      <p style="text-align:justify"><?php echo _TEXTEQUI; ?></p>
